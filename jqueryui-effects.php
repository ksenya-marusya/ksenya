 ...
 <div class="container">
   <div class="row">
     <div class="col-lg-4 col-md-4">
       <img src="img/Koala.jpg" class="img-responsive"  alt="">
       <button id="effect" class="btn btn-default btn-lg">Start Effect</button>
       </div>
     <div class="col-lg-4 col-md-4">
       <div class="exp"></div>
       <button id="effect1" class="btn btn-danger btn-lg">Start Explode Effect</button>
       </div>
      <div class="col-lg-4 col-md-4">
       <img src="img/Tulips.jpg" class="img-responsive"  alt="">
     </div>
   </div>
 </div>
 <div class="container mt50">
    <div class="row">
      <div class="col-lg-12 col-md-12">
         <h1 class="text-center">Show/Hide Effects</h1>
      </div>
    </div>
   <div class="row">
     <div class="col-lg-6 col-md-6">
       ...
       <button id="but" class="btn btn-info btn-lg">Show</button>
     </div>
     <div class="col-lg-6 col-md-6">
       <div class="article">
         Далеко-далеко за словесными горами в стране, гласных и согласных живут рыбные тексты. Города дороге дал образ текстов большого приставка языкового, меня, прямо ipsum снова! Пояс над города прямо. Заголовок, одна его строчка!
       </div>
       <button id="but2" class="btn btn-primary btn-sm">Hide</button>
     </div>
   </div>
 </div>
 <div class="container mt50">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6">
        <img id="tulips" src="/img/Tulips.jpg" class="img-responsive" alt="">
      </div>
      <div class="col-lg-6 col-md-6">
        <img id="koala" src="img/Koala.jpg" class="img-responsive" alt="">
      </div>
    </div>
 </div>
 <div class="container mt50">
   <div class="row">
     <div class="col-lg-12 col-md-12">
      ...
      <div class="col-lg-6 col-md-6">
        ...
        <button id="animate" class="btn btn-default btn-lg">Animate</button>
      </div>
      <div class="col-lg-6 col-md-6">
        <div class="anim2">
          Далеко-далеко за словесными горами в стране, гласных и согласных живут рыбные тексты. Рот заглавных, которое знаках текст своих единственное текста снова подпоясал рукописи его вдали первую напоивший продолжил запятых, ведущими взобравшись инициал.
        </div>
         <button id="animate1" class="btn btn-default btn-lg">Animate</button>
      </div>
   </div>
 </div>
<section>
...
<div class="container">
    <div class="row">
         <div class="col-lg-12 col-md-12">
             <h1 class="text-center">Switch Class</h1>
         </div>
    <div class="col-lg-6 col-md-12">
             <div id="switch" class="swadd">

             </div>
       <button id="swbut" class="btn btn-warning btn-lg">Switch Class</button>
